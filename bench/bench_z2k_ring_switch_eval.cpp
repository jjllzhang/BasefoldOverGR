...
BenchResult RunEvalBenchmark(const basefold::RingSwitchPCSParams &params,
  ...
  basefold::RingSwitchPCSEvalProof last_proof;
  ...
  if (have_last_proof) {
    outer_proof_size_bytes =
        basefold::RingSwitchPCSOuterProofSizeBytes(params, last_proof);
    proof_size_bytes =
        basefold::RingSwitchPCSEvalProofSizeBytes(params, last_proof);
  }
