...
// vec_ZZ_pE& b, ZZ p, long l, long s)
// {
...
//    vec_ZZ_pE res;
//    res.SetLength(m);
//    ofstream file1("z2ksnark/cache/inverse_162_k16.txt", ios::app);
//    for (k = 0; k < m; k++) {
...
// void interpolate_for_GR_cache(ZZ_pEX& f, const vec_ZZ_pE& a, const vec_ZZ_pE&
// b, ZZ p, long l, long s)
// {
//     load_inverse_cache();
...
//       //t1 = Inv(t1, s);
//     //   file>>t1;
//        // if (k >= inv_cache.length()) LogicError("inverse cache index out of
//        range");
//         t1 = inv_cache[k];
